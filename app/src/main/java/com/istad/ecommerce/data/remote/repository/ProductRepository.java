...
public class ProductRepository {
    ...
    /*Handle on update product*/
    public MutableLiveData<ProductPostResponse> updateProduct(int id, UpdateRequest updateRequest) {
        MutableLiveData<ProductPostResponse> liveData = new MutableLiveData<>();
        productService.updateProductID(id, updateRequest).enqueue(new Callback<ProductPostResponse>() {
            @Override
